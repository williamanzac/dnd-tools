...
extends AbstractWizardModel
{
    ...
    * calling {@link #add(nz.co.fitnet.wizard.WizardStep, Condition) add(step, TRUE_CONDITION)}.
    * <p>
    ...
    * condition is met.
    *
    * @param step      the {@link nz.co.fitnet.wizard.WizardStep} to add.
    ...
    * conditional steps by calling {@link Condition#evaluate(nz.co.fitnet.wizard.WizardModel)}.
    * <p>
