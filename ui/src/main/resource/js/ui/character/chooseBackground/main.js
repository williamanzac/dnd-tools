...
require([ 'jquery', 'bootstrap', 'knockout', '../model/CharacterBuilderModel', '../model/ChooseBackgroundStep', 'domReady!' ], function($,
        bootstrap, ko, CharacterBuilderModel, ChooseBackgroundStep) {
	...
	function Model() {
		...
		var step1 = new ChooseBackgroundStep();
